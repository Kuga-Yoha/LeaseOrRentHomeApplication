...
class DetachedHomes : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checkoutButton = findViewById<Button>(R.id.detached_house_checkout_button)
        val checkBox1 = findViewById<CheckBox>(R.id.checkbox_detached_home_one)
        val checkBox2 = findViewById<CheckBox>(R.id.checkbox_detached_home_two)
        val checkBox3 = findViewById<CheckBox>(R.id.checkbox_detached_home_three)
